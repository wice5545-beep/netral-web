...
export const translations: Record<Locale, any> = {
  fr: {
    ...
    chat: {
      ...
      reasoningTapToSee: 'Touchez pour voir mon esprit',
      reasoningThinking: 'Je réfléchis…',
      reasoningDuration: 'pensée en {seconds}s',
    },
    announcement: {
    ...
    pricingPage: {
      ...
      plans: [
        ...
        { name: 'Pro', price: '12€', period: '/mois', desc: 'Pour les professionnels et créateurs.', cta: 'Passer à Pro', features: ['Messages illimités', 'Recherche web avancée', 'Historique illimité', 'Conversations illimitées', 'Modèle prioritaire (NTRL 2.0)', 'Export des conversations', 'Support prioritaire'] },
      ...
      entries: [
        {
          version: 'v2.0',
          date: 'Juin 2025',
          title: 'NTRL 2.0 — Nouveau moteur de raisonnement',
          changes: [
            'Nouveau modele NTRL 2.0 avec raisonnement profond via glm-5.1',
  ...
  en: {
    ...
    chat: {
      ...
      reasoningTapToSee: 'Tap to see my mind',
      reasoningThinking: 'Thinking quietly…',
    ...
    pricingPage: {
      ...
      plans: [
        ...
        { name: 'Pro', price: '€12', period: '/month', desc: 'For professionals and creators.', cta: 'Upgrade to Pro', features: ['Unlimited messages', 'Advanced web search', 'Unlimited history', 'Unlimited conversations', 'Priority model (NTRL 2.0)', 'Conversation export', 'Priority support'] },
      ...
      entries: [
        {
          version: 'v2.0',
          date: 'June 2025',
          title: 'NTRL 2.0 — New reasoning engine',
          changes: [
            'New NTRL 2.0 model with deep reasoning via glm-5.1',
  ...
  es: {
    ...
    hero: { badge: 'NTRL 2.0 — Búsqueda web mejorada', title1: 'La IA que busca', title2: 'antes de responder.', subtitle: 'Haz una pregunta. Netral busca en la web, analiza fuentes y te da una respuesta precisa con citas verificables.', cta: 'Empezar gratis', login: 'Iniciar sesión', note: 'Gratis • Sin tarjeta • Listo en 10 segundos' },
  ...
  zh: {
    ...
    pricingPage: { back: '返回', title1: '简单定价，', title2: '没有惊喜。', subtitle: '免费开始。准备好时升级Pro。', popular: '热门', faqTitle: '常见问题', plans: [{ name: '免费', price: '€0', period: '/月', desc: '无承诺体验Netral。', cta: '开始', features: ['每天20条消息', '基础网络搜索', '7天历史记录', '1个同时对话'] }, { name: 'Pro', price: '€12', period: '/月', desc: '为专业人士和创作者。', cta: '升级到Pro', features: ['无限消息', '高级网络搜索', '无限历史记录', '无限对话', '优先模型 (NTRL 2.0)', '导出对话', '优先支持'] }, { name: '团队', price: '€29', period: '/用户/月', desc: '为想要协作的团队。', cta: '联系我们', features: ['包含Pro所有功能', '共享工作空间', '成员管理', 'API访问', 'SSO & SAML', 'SLA 99.9%', '专属客户经理'] }], faq: [{ q: '可以随时取消吗？', a: '是的。无承诺。在设置中一键取消。' }, { q: '我的数据安全吗？', a: '绝对安全。端到端加密，删除后不保留。' }, { q: 'Pro有消息限制吗？', a: '没有。Pro消息无限制。' }] },
  },

  ja: {
    nav: { features: '機能', pricing: '料金', login: 'ログイン', start: '始める' },
    hero: { badge: 'NTRL 2.0 — ウェブ検索改善', title1: '答える前に', title2: '検索するAI。', subtitle: '質問してください。Netralがウェブを検索し、ソースを分析し、検証可能な引用付きの正確な回答を提供します。', cta: '無料で始める', login: 'ログイン', note: '無料 • クレジットカード不要 • 10秒で準備完了' },
