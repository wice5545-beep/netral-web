...
const PLANS = [
  {
    ...
    badge: null,
    accent: false,
    description: 'Pour découvrir Netral.',
  ...
  },
  {
    ...
    badge: 'Power',
    accent: false,
    description: 'Sans limite, accès anticipé.',
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)] overflow-x-hidden noise-soft">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-28">
        ...
        >
          {['Annulation à tout moment', 'Paiement sécurisé · Stripe', 'Sans engagement', 'Support inclus'].map((s) => (
      ...
      <section className="border-t border-[var(--border)] py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-elevated)] overflow-hidden">
            <ComparisonRow header label="Fonctionnalité" cells={['Free', 'Plus', 'Pro', 'Pro+']} />
            ...
            <ComparisonRow label="Intégrations Google" cells={['—', '—', '✓', '✓']} />
            <ComparisonRow label="Accès anticipé" cells={['—', '—', '—', '✓']} />
            <ComparisonRow label="Support" cells={['Communauté', 'Email', 'Prioritaire', 'Dédié']} />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-[var(--border)] py-20">
        <div className="max-w-2xl mx-auto px-6">
          <motion.h2
            ...
            className="text-[28px] md:text-[36px] font-bold tracking-[-0.03em] mb-8 text-center"
          >
            {t.pricingPage?.faqTitle ?? 'Questions fréquentes'}
          </motion.h2>
