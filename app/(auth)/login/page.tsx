    ...
    <div className="min-h-screen flex bg-[var(--bg)] relative overflow-hidden">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative">
        ...
        >
          ...
          >
            {['IA contextuelle', 'Mémoire longue', 'Multi-modèles'].map((f) => (
              <span
                key={f}
                className="px-3 py-1 rounded-full text-[12px] font-medium border border-[var(--border)] text-[var(--fg-muted)] bg-[var(--bg-soft)]"
              >
                {f}
              </span>
            ))}
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <div className="mb-8">
            <h1 className="text-[26px] font-bold tracking-[-0.025em] mb-1.5">{t.chat.loginTitle}</h1>
          ...
          {/* Google OAuth button — direct link, no JS dependency */}
          <a
          ...
          <p className="mt-7 text-[13px] text-center text-[var(--fg-muted)]">
            ...
            <Link href="/register" className="text-[var(--fg)] font-semibold hover:underline underline-offset-2">
              {t.chat.createOne}
            </Link>
          </p>
        </motion.div>
