    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] px-6 py-12 relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="p-6 rounded-2xl glass-card shadow-colored"
        >
          <form action={action} className="space-y-4">
            <Input id="name" name="name" type="text" placeholder="Prénom" icon={<UserIcon size={14} />} error={state?.errors?.name?.[0]} autoComplete="name" required />
